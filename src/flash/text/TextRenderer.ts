...
module Shumway.AVMX.AS.flash.text {
	...
	export class TextRenderer extends ASObject {
		...
		set antiAliasType(value: string) {
			...
			release || notImplemented("public flash.text.TextRenderer::set antiAliasType");
			return;
		...
		set maxLevel(value: number /*int*/) {
			value = value | 0;
			release || notImplemented("public flash.text.TextRenderer::set maxLevel");
			return;
		...
		set displayMode(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.TextRenderer::set displayMode");
			return;
		...
		static setAdvancedAntiAliasingTable(fontName: string, fontStyle: string, colorType: string, advancedAntiAliasingTable: ASArray): void {
			...
			advancedAntiAliasingTable = advancedAntiAliasingTable;
			release || notImplemented("public flash.text.TextRenderer::static setAdvancedAntiAliasingTable");
			return;
		}
