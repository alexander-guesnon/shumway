...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class TextJustifier extends ASObject {
		...
		set lineJustification(value: string) {
			...
			release || notImplemented("public flash.text.engine.TextJustifier::set lineJustification");
			return;
		...
		setLocale(value: string): void {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.TextJustifier::setLocale");
			return;
		}
	}
}
