...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class EastAsianJustifier extends flash.text.engine.TextJustifier {
		...
		set justificationStyle(value: string) {
			...
			release || notImplemented("public flash.text.engine.EastAsianJustifier::set justificationStyle");
			return;
		...
		set composeTrailingIdeographicSpaces(value: boolean) {
			value = !!value;
			release || notImplemented("public flash.text.engine.EastAsianJustifier::set composeTrailingIdeographicSpaces");
			return;
