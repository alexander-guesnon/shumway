...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class TextBlock extends ASObject {
		...
		constructor(content: flash.text.engine.ContentElement = null, tabStops: any /*ASVector> /* flash.text.engine.TabStop */ = null, textJustifier: flash.text.engine.TextJustifier = null, lineRotation: string = "rotate0", baselineZero: string = "roman", bidiLevel: number /*int*/ = 0, applyNonLinearFontScaling: boolean = true, baselineFontDescription: flash.text.engine.FontDescription = null, baselineFontSize: number = 12) {
			...
			lineRotation = axCoerceString(lineRotation);
			baselineZero = axCoerceString(baselineZero);
			bidiLevel = bidiLevel | 0;
			applyNonLinearFontScaling = !!applyNonLinearFontScaling;
			baselineFontDescription = baselineFontDescription;
		...
		set applyNonLinearFontScaling(value: boolean) {
			value = !!value;
			release || notImplemented("public flash.text.engine.TextBlock::set applyNonLinearFontScaling");
			return;
		...
		set baselineFontDescription(value: flash.text.engine.FontDescription) {
			value = value;
			release || notImplemented("public flash.text.engine.TextBlock::set baselineFontDescription");
			return;
		...
		set baselineFontSize(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.TextBlock::set baselineFontSize");
			return;
		...
		set baselineZero(value: string) {
			...
			release || notImplemented("public flash.text.engine.TextBlock::set baselineZero");
			return;
		...
		set content(value: flash.text.engine.ContentElement) {
			value = value;
			release || notImplemented("public flash.text.engine.TextBlock::set content");
			return;
			// this._content = value;
		}
		...
		set bidiLevel(value: number /*int*/) {
			value = value | 0;
			release || notImplemented("public flash.text.engine.TextBlock::set bidiLevel");
			return;
		...
		set lineRotation(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.TextBlock::set lineRotation");
			return;
		...
		releaseLineCreationData(): void {
			release || notImplemented("public flash.text.engine.TextBlock::releaseLineCreationData");
			return;
		}
		...
		releaseLines(firstLine: flash.text.engine.TextLine, lastLine: flash.text.engine.TextLine): void {
			firstLine = firstLine;
			lastLine = lastLine;
			release || notImplemented("public flash.text.engine.TextBlock::releaseLines");
			return;
		}
...
//    }
		...
		setTextJustifier(value: flash.text.engine.TextJustifier): void {
			value = value;
			release || notImplemented("public flash.text.engine.TextBlock::setTextJustifier");
			return;
		}
	}
}
