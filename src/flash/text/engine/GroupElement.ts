...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class GroupElement extends flash.text.engine.ContentElement {
		...
		ungroupElements(groupIndex: number /*int*/): void {
			...
			release || notImplemented("public flash.text.engine.GroupElement::ungroupElements");
			return;
		}
		...
		replaceElements(beginIndex: number /*int*/, endIndex: number /*int*/, newElements: any /*ASVector*/): any /*ASVector*/ {
			...
			release || notImplemented("public flash.text.engine.GroupElement::replaceElements");
			return;
		}
