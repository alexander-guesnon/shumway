...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class SpaceJustifier extends flash.text.engine.TextJustifier {
		...
		set letterSpacing(value: boolean) {
			value = !!value;
			release || notImplemented("public flash.text.engine.SpaceJustifier::set letterSpacing");
			return;
		...
		set minimumSpacing(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.SpaceJustifier::set minimumSpacing");
			return;
		...
		set optimumSpacing(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.SpaceJustifier::set optimumSpacing");
			return;
		...
		set maximumSpacing(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.SpaceJustifier::set maximumSpacing");
			return;
