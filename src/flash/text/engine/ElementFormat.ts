...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class ElementFormat extends ASObject {
		...
		set alignmentBaseline(alignmentBaseline: string) {
			alignmentBaseline = axCoerceString(alignmentBaseline);
			release || notImplemented("public flash.text.engine.ElementFormat::set alignmentBaseline");
			return;
		...
		set alpha(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.ElementFormat::set alpha");
			return;
			// this._alpha = value;
		}
		...
		set baselineShift(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.ElementFormat::set baselineShift");
			return;
		...
		set breakOpportunity(opportunityType: string) {
			...
			release || notImplemented("public flash.text.engine.ElementFormat::set breakOpportunity");
			return;
		...
		set color(value: number /*uint*/) {
			value = value >>> 0;
			release || notImplemented("public flash.text.engine.ElementFormat::set color");
			return;
			// this._color = value;
		}
		...
		set dominantBaseline(dominantBaseline: string) {
			dominantBaseline = axCoerceString(dominantBaseline);
			release || notImplemented("public flash.text.engine.ElementFormat::set dominantBaseline");
			return;
		...
		set fontDescription(value: flash.text.engine.FontDescription) {
			value = value;
			release || notImplemented("public flash.text.engine.ElementFormat::set fontDescription");
			return;
		...
		set digitCase(digitCaseType: string) {
			...
			release || notImplemented("public flash.text.engine.ElementFormat::set digitCase");
			return;
		...
		set digitWidth(digitWidthType: string) {
			...
			release || notImplemented("public flash.text.engine.ElementFormat::set digitWidth");
			return;
		...
		set ligatureLevel(ligatureLevelType: string) {
			...
			release || notImplemented("public flash.text.engine.ElementFormat::set ligatureLevel");
			return;
		...
		set fontSize(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.ElementFormat::set fontSize");
			return;
		...
		set kerning(value: string) {
			...
			release || notImplemented("public flash.text.engine.ElementFormat::set kerning");
			return;
			// this._kerning = value;
		}
		...
		set locale(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.ElementFormat::set locale");
			return;
			// this._locale = value;
		}
		...
		set textRotation(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.ElementFormat::set textRotation");
			return;
		...
		set trackingRight(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.ElementFormat::set trackingRight");
			return;
		...
		set trackingLeft(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.ElementFormat::set trackingLeft");
			return;
		...
		set typographicCase(typographicCaseType: string) {
			...
			release || notImplemented("public flash.text.engine.ElementFormat::set typographicCase");
			return;
		...
		set locked(value: boolean) {
			value = !!value;
			release || notImplemented("public flash.text.engine.ElementFormat::set locked");
			return;
			// this._locked = value;
		}
