...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class ContentElement extends ASObject {
		...
		set elementFormat(value: flash.text.engine.ElementFormat) {
			value = value;
			release || notImplemented("public flash.text.engine.ContentElement::set elementFormat");
			return;
		...
		set eventMirror(value: flash.events.EventDispatcher) {
			value = value;
			release || notImplemented("public flash.text.engine.ContentElement::set eventMirror");
			return;
		...
		set textRotation(value: string) {
			...
			release || notImplemented("public flash.text.engine.ContentElement::set textRotation");
			return;
