...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class GraphicElement extends flash.text.engine.ContentElement {
		...
		get graphic(): flash.display.DisplayObject {
			release || notImplemented("public flash.text.engine.GraphicElement::get graphic");
			return;
		...
		set graphic(value: flash.display.DisplayObject) {
			value = value;
			release || notImplemented("public flash.text.engine.GraphicElement::set graphic");
			return;
			// this._graphic = value;
		}
		...
		set elementHeight(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.GraphicElement::set elementHeight");
			return;
		...
		set elementWidth(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.GraphicElement::set elementWidth");
			return;
