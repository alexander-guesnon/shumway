...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class TabStop extends ASObject {
		...
		set alignment(value: string) {
			...
			release || notImplemented("public flash.text.engine.TabStop::set alignment");
			return;
		...
		set position(value: number) {
			value = +value;
			release || notImplemented("public flash.text.engine.TabStop::set position");
			return;
		...
		set decimalAlignmentToken(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.TabStop::set decimalAlignmentToken");
			return;
