...
module Shumway.AVMX.AS.flash.text.engine {
	...
	export class FontDescription extends ASObject {
		...
		set renderingMode(value: string) {
			...
			release || notImplemented("public flash.text.engine.FontDescription::set renderingMode");
			return;
		...
		set fontLookup(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.FontDescription::set fontLookup");
			return;
		...
		set fontName(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.FontDescription::set fontName");
			return;
		...
		set fontPosture(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.FontDescription::set fontPosture");
			return;
		...
		set fontWeight(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.FontDescription::set fontWeight");
			return;
		...
		set cffHinting(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.text.engine.FontDescription::set cffHinting");
			return;
		...
		set locked(value: boolean) {
			value = !!value;
			release || notImplemented("public flash.text.engine.FontDescription::set locked");
			return;
			// this._locked = value;
		}
	}
