...
module Shumway.AVMX.AS.flash.display3D {
	...
	export class VertexBuffer3D extends ASObject {
		...
		uploadFromVector(data: any /*ASVector*/, startVertex: number /*int*/, numVertices: number /*int*/): void {
			...
			release || notImplemented("public flash.display3D.VertexBuffer3D::uploadFromVector");
			return;
		}
		...
		uploadFromByteArray(data: flash.utils.ByteArray, byteArrayOffset: number /*int*/, startVertex: number /*int*/, numVertices: number /*int*/): void {
			...
			startVertex = startVertex | 0;
			numVertices = numVertices | 0;
			release || notImplemented("public flash.display3D.VertexBuffer3D::uploadFromByteArray");
			return;
		}

		dispose(): void {
			release || notImplemented("public flash.display3D.VertexBuffer3D::dispose");
			return;
		}
	}
}
