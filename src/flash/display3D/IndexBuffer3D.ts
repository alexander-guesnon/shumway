...
module Shumway.AVMX.AS.flash.display3D {
	...
	export class IndexBuffer3D extends ASObject {
		...
		uploadFromVector(data: any /*ASVector*/, startOffset: number /*int*/, count: number /*int*/): void {
			...
			count = count | 0;
			release || notImplemented("public flash.display3D.IndexBuffer3D::uploadFromVector");
			return;
		}
		...
		uploadFromByteArray(data: flash.utils.ByteArray, byteArrayOffset: number /*int*/, startOffset: number /*int*/, count: number /*int*/): void {
			...
			startOffset = startOffset | 0;
			count = count | 0;
			release || notImplemented("public flash.display3D.IndexBuffer3D::uploadFromByteArray");
			return;
		}

		dispose(): void {
			release || notImplemented("public flash.display3D.IndexBuffer3D::dispose");
			return;
		}
	}
}
