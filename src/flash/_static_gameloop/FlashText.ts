module Shumway.AVMX.AS.flash.statics {
	...
	export class FlashText {
		...
		DEVICE_FONT_METRICS_WIN: Object;
		DEVICE_FONT_METRICS_LINUX: Object;
		DEVICE_FONT_METRICS_MAC: Object;
		DEVICE_FONT_METRICS_BUILTIN: Object;
		...
		getByNameAndStyle(name: string, style: string): Font {
			...
			if (!font) {
				font = new this.context.sec.flash.text.Font();
