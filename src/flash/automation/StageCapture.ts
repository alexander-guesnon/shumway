...
module Shumway.AVMX.AS.flash.automation {
	...
	export class StageCapture extends flash.events.EventDispatcher {
		...
		capture(type: string): void {
			...
			release || notImplemented("public flash.automation.StageCapture::capture");
			return;
		}

		cancel(): void {
			release || notImplemented("public flash.automation.StageCapture::cancel");
			return;
		}

		set fileNameBase(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.automation.StageCapture::set fileNameBase");
			return;
		}
		...
		set clipRect(value: flash.geom.Rectangle) {
			value = value;
			release || notImplemented("public flash.automation.StageCapture::set clipRect");
			return;
		}
		...
		set captureSource(value: string) {
			value = axCoerceString(value);
			release || notImplemented("public flash.automation.StageCapture::set captureSource");
			return;
		}
