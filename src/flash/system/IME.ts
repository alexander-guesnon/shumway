...
module Shumway.AVMX.AS.flash.system {
	...
	export class IME extends flash.events.EventDispatcher {
		...
		set enabled(enabled: boolean) {
			enabled = !!enabled;
			release || notImplemented("public flash.system.IME::set enabled");
			return;
		...
		set conversionMode(mode: string) {
			...
			release || notImplemented("public flash.system.IME::set conversionMode");
			return;
		...
		static setCompositionString(composition: string): void {
			...
			release || notImplemented("public flash.system.IME::static setCompositionString");
			return;
		}

		static doConversion(): void {
			release || notImplemented("public flash.system.IME::static doConversion");
			return;
		}
		...
		static compositionSelectionChanged(start: number /*int*/, end: number /*int*/): void {
			...
			release || notImplemented("public flash.system.IME::static compositionSelectionChanged");
			return;
		}

		static compositionAbandoned(): void {
			release || notImplemented("public flash.system.IME::static compositionAbandoned");
			return;
		}
