...
module Shumway.AVMX.AS.flash.system {
	...
	export class AuthorizedFeaturesLoader extends flash.events.EventDispatcher {
		...
		get authorizedFeatures(): flash.system.AuthorizedFeatures {
			release || notImplemented("public flash.system.AuthorizedFeaturesLoader::get authorizedFeatures");
			return;
			// return this._authorizedFeatures;
		}

		loadAuthorizedFeatures(): void {
			release || notImplemented("public flash.system.AuthorizedFeaturesLoader::loadAuthorizedFeatures");
			return;
		}

		makeGlobal(): void {
			release || notImplemented("public flash.system.AuthorizedFeaturesLoader::makeGlobal");
			return;
		}
	}
}
