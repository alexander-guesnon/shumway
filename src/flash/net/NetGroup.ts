...
module Shumway.AVMX.AS.flash.net {
	...
	export class NetGroup extends flash.events.EventDispatcher {
		...
		constructor(connection: flash.net.NetConnection, groupspec: string) {
			...
			groupspec = axCoerceString(groupspec);
		}
		...
		get info(): flash.net.NetGroupInfo {
			release || notImplemented("public flash.net.NetGroup::get info");
			return;
			// return this._info;
		}
		...
		convertPeerIDToGroupAddress(peerID: string): string {
			...
			release || notImplemented("public flash.net.NetGroup::convertPeerIDToGroupAddress");
			return;
		}

		get localCoverageFrom(): string {
			release || notImplemented("public flash.net.NetGroup::get localCoverageFrom");
			return;
			// return this._localCoverageFrom;
		}

		get localCoverageTo(): string {
			release || notImplemented("public flash.net.NetGroup::get localCoverageTo");
			return;
