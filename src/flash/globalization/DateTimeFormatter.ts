...
module Shumway.AVMX.AS.flash.globalization {
	...
	export class DateTimeFormatter extends ASObject {
		...
		constructor(requestedLocaleIDName: string, dateStyle: string = "long", timeStyle: string = "long") {
			...
			dateStyle = axCoerceString(dateStyle);
			timeStyle = axCoerceString(timeStyle);
		}
		...
		get lastOperationStatus(): string {
			release || notImplemented("public flash.globalization.DateTimeFormatter::get lastOperationStatus");
			return;
			// return this._lastOperationStatus;
		}

		get requestedLocaleIDName(): string {
			release || notImplemented("public flash.globalization.DateTimeFormatter::get requestedLocaleIDName");
			return;
			// return this._requestedLocaleIDName;
		}

		get actualLocaleIDName(): string {
			release || notImplemented("public flash.globalization.DateTimeFormatter::get actualLocaleIDName");
			return;
		...
		setDateTimeStyles(dateStyle: string, timeStyle: string): void {
			dateStyle = axCoerceString(dateStyle);
			timeStyle = axCoerceString(timeStyle);
			release || notImplemented("public flash.globalization.DateTimeFormatter::setDateTimeStyles");
			return;
		}

		getTimeStyle(): string {
			release || notImplemented("public flash.globalization.DateTimeFormatter::getTimeStyle");
			return;
		}

		getDateStyle(): string {
			release || notImplemented("public flash.globalization.DateTimeFormatter::getDateStyle");
			return;
		}
		...
		getFirstWeekday(): number /*int*/ {
			release || notImplemented("public flash.globalization.DateTimeFormatter::getFirstWeekday");
			return;
		}

		getDateTimePattern(): string {
			release || notImplemented("public flash.globalization.DateTimeFormatter::getDateTimePattern");
			return;
		}

		setDateTimePattern(pattern: string): void {
			pattern = axCoerceString(pattern);
			release || notImplemented("public flash.globalization.DateTimeFormatter::setDateTimePattern");
			return;
		}
		...
		ctor(requestedLocaleIDName: string, dateStyle: string, timeStyle: string): void {
			...
			dateStyle = axCoerceString(dateStyle);
			timeStyle = axCoerceString(timeStyle);
			release || notImplemented("public flash.globalization.DateTimeFormatter::ctor");
			return;
		}
		...
		formatImplementation(dateTime: ASDate, utc: boolean): string {
			dateTime = dateTime;
			utc = !!utc;
			release || notImplemented("public flash.globalization.DateTimeFormatter::formatImplementation");
			return;
		}
	}
}
