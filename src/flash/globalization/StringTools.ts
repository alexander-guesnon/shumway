...
module Shumway.AVMX.AS.flash.globalization {
	...
	export class StringTools extends ASObject {
		...
		get lastOperationStatus(): string {
			release || notImplemented("public flash.globalization.StringTools::get lastOperationStatus");
			return;
			// return this._lastOperationStatus;
		}

		get requestedLocaleIDName(): string {
			release || notImplemented("public flash.globalization.StringTools::get requestedLocaleIDName");
			return;
			// return this._requestedLocaleIDName;
		}

		get actualLocaleIDName(): string {
			release || notImplemented("public flash.globalization.StringTools::get actualLocaleIDName");
			return;
		...
		toLowerCase(s: string): string {
			s = axCoerceString(s);
			release || notImplemented("public flash.globalization.StringTools::toLowerCase");
			return;
		}

		toUpperCase(s: string): string {
			s = axCoerceString(s);
			release || notImplemented("public flash.globalization.StringTools::toUpperCase");
			return;
		}

		ctor(requestedLocaleIDName: string): void {
			requestedLocaleIDName = axCoerceString(requestedLocaleIDName);
			release || notImplemented("public flash.globalization.StringTools::ctor");
			return;
		}
	}
}
