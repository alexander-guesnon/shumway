...
module Shumway.AVMX.AS.flash.globalization {
	...
	export class NumberParseResult extends ASObject {
		...
		get value(): number {
			release || notImplemented("public flash.globalization.NumberParseResult::get value");
			return;
			// return this._value;
		}

		get startIndex(): number /*int*/ {
			release || notImplemented("public flash.globalization.NumberParseResult::get startIndex");
			return;
			// return this._startIndex;
		}

		get endIndex(): number /*int*/ {
			release || notImplemented("public flash.globalization.NumberParseResult::get endIndex");
			return;
		...
		ctor(value: number, startIndex: number /*int*/, endIndex: number /*int*/): void {
			...
			startIndex = startIndex | 0;
			endIndex = endIndex | 0;
			release || notImplemented("public flash.globalization.NumberParseResult::ctor");
			return;
		}
	}
}
