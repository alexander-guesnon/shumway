...
module Shumway.AVMX.AS.flash.desktop {
	...
	export class Clipboard extends ASObject {
		...
		get generalClipboard(): flash.desktop.Clipboard {
			release || notImplemented("public flash.desktop.Clipboard::get generalClipboard");
			return;
		...
		// _formats: any [];
		get formats(): any [] {
			release || notImplemented("public flash.desktop.Clipboard::get formats");
			return;
			// return this._formats;
		}

		clear(): void {
			release || notImplemented("public flash.desktop.Clipboard::clear");
			return;
		}

		clearData(format: string): void {
			format = axCoerceString(format);
			release || notImplemented("public flash.desktop.Clipboard::clearData");
			return;
		}
	}
}
